...
export default function VesselMarker({ vessel, popup }: IVesselMarker) {
  ...
  const icon = L.divIcon({
    ...
    html: `
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-rocket" viewBox="0 0 16 16" style="${selectedVesselmmsi === vessel?.mmsi ? "color: #da3122;" : ""} transform: translate(-10px, -10px) rotate(${
